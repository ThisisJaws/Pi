...
protected:
	...
	irr::scene::ITerrainSceneNode* loadTerrain(irr::IrrlichtDevice *device, const irr::io::path &heightMapFileLocation, irr::video::ITexture *texture, irr::core::vector3df position = irr::core::vector3df(0), irr::core::vector3df &scaleFactor = irr::core::vector3df(1, 1, 1), irr::s32 smoothFactor = 1, float tileAmount = 20.0f);
