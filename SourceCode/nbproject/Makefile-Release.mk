...
${OBJECTDIR}/BasicEnemy.o: BasicEnemy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasicEnemy.o BasicEnemy.cpp
...
${OBJECTDIR}/FastEnemy.o: FastEnemy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FastEnemy.o FastEnemy.cpp
...
${OBJECTDIR}/StrongEnemy.o: StrongEnemy.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StrongEnemy.o StrongEnemy.cpp
